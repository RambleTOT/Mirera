...
public class MirrorEditorActivity extends AppCompatActivity implements View.OnClickListener, MediaPlayer.OnPreparedListener, SurfaceHolder.Callback, View.OnTouchListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mirror_editor);
        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
        init();
    }

    private void init(){
        buttonMirror = findViewById(R.id.buttonMirrorChoice);
        buttonMirror.setOnClickListener(this);
        surfaceView =
                (SurfaceView) findViewById(R.id.surfaceEditor);
        surfaceView.setOnTouchListener(this);
        _surfaceHolder = surfaceView.getHolder();
        _surfaceHolder.addCallback(this);
        _surfaceHolder.setFixedSize(320, 240);
        surfaceView2 = (SurfaceView)findViewById(R.id.surfaceDrawEditor);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.buttonMirrorChoice:
                saveCoordinates();
                Intent intent = new Intent(MirrorEditorActivity.this, MainMenuActivity.class);
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                Toast.makeText(this, xl + " " + yt + " " + xr + " " + yb, Toast.LENGTH_SHORT).show();
                drawFocusRect(xl , yt , xr , yb, getResources().getColor(R.color.color_main));
